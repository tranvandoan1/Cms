  ...
  return (
    <div>
      ...
      >
        ...
        >
          <Input  placeholder="Tên Các Stage Plot " defaultValue={StagePlot?.name} />
        </Form.Item>
        ...
        >
          <Input type="number" placeholder="Nhập Tuổi của bạn!"  defaultValue={StagePlot?.age}/>
        </Form.Item>
        <Form.Item
          label="Màu sắc"
          labelAlign="left"
        ...
        >
          <Input type="text" placeholder="chọn màu" defaultValue={StagePlot?.color} />
        </Form.Item>
        <Form.Item
          wrapperCol={{
            offset: 6,
